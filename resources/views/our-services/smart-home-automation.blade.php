...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <h2 class="text-2xl font-semibold text-gray-800">Seamless Device Integration</h2>
            <p class="text-gray-700 mt-2">
                Integrate all your smart devices into one cohesive ecosystem for effortless control and convenience.
            </p>

            <h2 class="text-2xl font-semibold text-gray-800">Energy Management</h2>
            <p class="text-gray-700 mt-2">
                Optimize energy usage with automated lighting, heating, and cooling systems to reduce your carbon footprint.
            </p>

            <h2 class="text-2xl font-semibold text-gray-800">Enhanced Home Security</h2>
            <p class="text-gray-700 mt-2">
