...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">IT Strategy Development</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Technology Assessments and Recommendations</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">IT Project Management</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Digital Transformation Consulting</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Data Analytics and Business Intelligence</h2>
                <p class="text-gray-700 mt-2">
