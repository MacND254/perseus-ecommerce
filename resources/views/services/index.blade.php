...
<section class="container mx-auto py-12 px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
        ...
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">Managed IT Services</h2>
        ...
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">Software Development</h2>
        ...
        <!-- IT Consulting -->
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">IT Consulting</h2>
        ...
        <!-- Cloud Computing -->
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">Cloud Computing</h2>
        ...
        <!-- Cybersecurity -->
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">Cybersecurity</h2>
        ...
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">Smart Home Automation</h2>
        ...
        <div class="p-6 bg-white shadow-lg rounded-lg">
            <h2 class="text-xl font-semibold mb-2">Network Installations</h2>
