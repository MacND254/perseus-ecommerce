...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/categories_tags', [PostCategoryController::class, 'index'])->name('categories_tags.edit');
    Route::get('/categories_tags', [PostCategoryController::class, 'index'])->name('categories_destroy');
    Route::get('/categories_tags', [PostCategoryController::class, 'index'])->name('categories_tags.create');
