...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/categories_tags/edit', [PostController::class, 'edit'])->name('categories_tags.edit');
    Route::get('/categories_tags', [PostCategoryController::class, 'destroy'])->name('categories_destroy');
    Route::get('/categories_tags/create', [PostCategoryController::class, 'create'])->name('categories_tags.create');
