...
Route::prefix('admin')->name('admin.')->group(function () {
    Route::middleware(['guest:admin'])->group(function () {
        Route::get('/auth/a-login', [AdminLoginController::class, 'showLoginForm'])->name('login');
        Route::post('/auth/a-login', [AdminLoginController::class, 'login'])->name('login.submit');
    });
...
Route::prefix('admin')->name('admin.')->middleware('auth:admin')->group(function () {
    ...
    Route::get('/categories-tags', [CategoryTagController::class, 'index'])->name('categories.tags');
