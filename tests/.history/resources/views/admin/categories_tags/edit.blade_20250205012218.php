...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('admin.categories_tags.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $post_category->name) }}"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.categories_tags.index') }}"
