...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="bg-white shadow-md rounded my-6 p-4">
            <form action="{{ route('admin.categories_tags.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <a href="{{ route('admin.categories_tags.index') }}" class="text-blue-500 hover:text-blue-700">Back to Categories</a>
    </div>
@endsection
