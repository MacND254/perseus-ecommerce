        ...
        <ul class="space-y-2">
            ...
            <li class="relative">
                ...
                <ul id="content-management" class="hidden bg-gray-700 ml-4 rounded">
                    ...
                    <li><a href="{{ route('admin.categories.tags') }}" class="block py-2 px-4 hover:bg-gray-600">Categories & Tags</a></li>
                </ul>
            </li>
            ...
            <!-- Analytics -->
            <li>
                <a href="{{ route('admin.analytics') }}" class="block py-2 px-4 hover:bg-gray-700 rounded">
                    Analytics
                </a>
            </li>
