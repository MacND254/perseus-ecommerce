...
<div class="mt-4 border-t pt-4">
    <div class="flex justify-between text-sm text-gray-500">
        <span>Subtotal:</span>
        <span>KES {{ isset($subtotal) ? number_format($subtotal, 2) : '0.00' }}</span>
    </div>
    <div class="flex justify-between text-sm text-gray-500">
        <span>VAT (16%):</span>
        <span>KES {{ isset($vat) ? number_format($vat, 2) : '0.00' }}</span>
    </div>
    <div class="flex justify-between font-bold text-lg text-gray-500">
        <span>Total:</span>
        <span>KES {{ isset($total) ? number_format($total, 2) : '0.00' }}</span>
    </div>
</div>
