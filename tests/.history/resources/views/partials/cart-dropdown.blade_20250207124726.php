...
<!-- Cart Dropdown -->
<div id="cart-dropdown" class="hidden absolute top-16 right-4 w-96 max-h-[80vh] bg-white rounded-lg shadow-lg overflow-y-auto z-[9999] p-4 border border-gray-200">
    @if(count($cart) > 0)
