...
<section class="container mx-auto py-12">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="col-span-1">
          ...
          <!-- Add to Cart Form -->
          <form wire:submit.prevent="addToCart({{ $product->id }}, document.getElementById('quantity').value)">
            <input type="number" id="quantity" name="quantity" value="1" min="1">

            <button type="button" data-product-id="{{ $product->id }}" class="add-to-cart-btn bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 mt-4">
    Add to Cart
</button>
        </form>
