...
<form id="addToCartForm">
    @csrf  <!-- CSRF protection for the AJAX request -->
...
<script>
    ...
    document.getElementById('addToCartForm').addEventListener('submit', function(event) {
        ...
        console.log("Submitting product:", productId, "with quantity:", quantity);  // Debugging output

        fetch(`{{ route('cart.add', ['productId' => $product->id]) }}`, {
    method: 'POST',
    headers: {
