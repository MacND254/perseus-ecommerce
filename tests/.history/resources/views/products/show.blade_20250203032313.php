...
<section class="container mx-auto py-12">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="col-span-1">
          ...
          <!-- Add to Cart Form -->
          <form wire:submit.prevent="addToCart({{ $product->id }}, document.getElementById('quantity').value, document.getElementById('size').value, document.getElementById('color').value)">
            ...
            <button wire:click="addToCart({{ $product->id }}, 1, '{{ $selectedSize }}', '{{ $selectedColor }}')"
