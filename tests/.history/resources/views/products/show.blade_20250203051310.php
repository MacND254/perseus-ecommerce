...
<form id="addToCartForm">
    ...
    <input type="number" id="quantity" name="quantity" value="1" min="1" class="w-20 border rounded p-2 mb-4">

    <label for="size" class="block font-semibold">Size:</label>
    <select id="size" name="size" class="p-2 border rounded w-full">
    ...
    <label for="color" class="block font-semibold mt-2">Color:</label>
    <select id="color" name="color" class="p-2 border rounded w-full">
...
document.getElementById('addToCartForm').addEventListener('submit', function(event) {
    ...
    fetch("{{ route('cart.add') }}", {  // ✅ Now correct
        method: 'POST',
        headers: {
