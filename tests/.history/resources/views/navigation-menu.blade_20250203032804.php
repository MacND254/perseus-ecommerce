       ...
       <li class="relative">
        <button id="cart-button" class="relative focus:outline-none">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l3-7H5.4M16 21a1 1 0 100-2 1 1 0 000 2zM7 21a1 1 0 100-2 1 1 0 000 2z"></path>
            </svg>
            <span id="cart-count" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">
                {{ session('cart') ? count(session('cart')) : 0 }}
            </span>
        </button>

        <!-- Cart Dropdown --
        <div id="cart-dropdown" class="hidden absolute right-0 mt-3 bg-white text-gray-800 shadow-lg rounded-lg w-[500px] max-h-[80vh] overflow-y-auto border border-gray-200 z-50">
