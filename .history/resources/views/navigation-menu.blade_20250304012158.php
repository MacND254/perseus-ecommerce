...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 bg-gray-800 bg-opacity-95 z-100">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (menuToggle && mobileMenu) {
            ...
            menuToggle.addEventListener('click', (event) => {
                ...
                // ✅ Delay the outside click listener to prevent immediate closing
                setTimeout(() => {
            ...
            function closeOnClickOutside(event) {
                if (!mobileMenu.contains(event.target) && !menuToggle.contains(event.target)) {
                    mobileMenu.classList.add('hidden'); // Hide menu
                    document.removeEventListener('click', closeOnClickOutside); // Remove listener
                }
            }
