...
<nav class="bg-gray-500 text-gray-900 shadow-md">
    <div class="max-w-7xl mx-auto flex justify-between items-center py-3 px-4">
        <!-- Logo -->
        <a href="{{ route('home') }}" class="text-2xl font-bold text-gray-900">Perseus Enterprises</a>

        <!-- Desktop Navigation Links -->
        <ul class="hidden md:flex space-x-4">
            <li><a href="{{ route('home') }}" class="hover:bg-gray-600 px-3 py-2 rounded">Home</a></li>
            <li><a href="{{ route('about-us.index') }}" class="hover:bg-gray-600 px-3 py-2 rounded">About Us</a></li>
            <li><a href="{{ route('services.index') }}" class="hover:bg-gray-600 px-3 py-2 rounded">Services</a></li>
            <li><a href="{{ route('career.index') }}" class="hover:bg-gray-600 px-3 py-2 rounded">Career</a></li>
            <li><a href="{{ route('blog.index') }}" class="hover:bg-gray-600 px-3 py-2 rounded">Blog</a></li>
            <li><a href="{{ route('products.index') }}" class="hover:bg-gray-600 px-3 py-2 rounded">Shop</a></li>
            <li><a href="{{ route('contact-us.index') }}" class="hover:bg-gray-600 px-3 py-2 rounded">Contact Us</a></li>
        </ul>
    ...
    <div id="mobile-menu" class="hidden fixed top-[56px] left-0 w-1/2 h-[calc(100%-60px)]  bg-opacity-50 backdrop-blur-lg transform -translate-x-full transition-transform duration-300 ease-in-out z-50 flex flex-col">
        ...
        <div class="relative w-1/2 h-full w-full bg-gray-400 bg-opacity-50 p-6">
            ...
            <div class="mt-auto mb-[10px] text-center text-black text-sm py-4 border-t border-gray-700">
                &copy; 2025 Perseus
            </div>
