...
<div class="relative">
    <button id="cart-toggle" class="relative">
        🛒 <span class="cart-count bg-red-500 text-white text-xs rounded-full px-2">{{ $cartCount ?? 0 }}</span>
    </button>

    <!-- Cart Dropdown -->
    <div id="cart-dropdown" class="absolute right-0 mt-2 w-80 bg-white border rounded shadow-lg hidden">
