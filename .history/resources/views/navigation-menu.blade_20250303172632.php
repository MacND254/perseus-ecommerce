...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 bg-gray-800 bg-opacity-95 z-50000000">
...
<script>
   document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuToggle && mobileMenu && menuClose && servicesToggle && mobileServicesDropdown && servicesDropdownToggle && servicesDropdownMenu) {
        console.log("All elements found!"); // Debugging
        ...
        menuClose.addEventListener('click', () => {
            console.log("Menu Close Clicked!"); // Debugging
        ...
        mobileMenu.addEventListener('click', (event) => {
            if (event.target === mobileMenu) {
                console.log("Clicked outside mobile menu!"); // Debugging
                mobileMenu.classList.add('hidden');
            }
        });
        ...
        servicesToggle.addEventListener('click', () => {
            console.log("Services Toggle Clicked!"); // Debugging
        ...
        servicesDropdownToggle.addEventListener('click', (event) => {
            ...
            console.log("Services Dropdown Toggle Clicked!"); // Debugging
