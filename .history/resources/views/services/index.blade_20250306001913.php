...
<section class="container mx-auto py-12 px-6">
    <!-- Page Heading -->
    <h1 class="text-4xl font-bold text-center text-gray-500">Our Services</h1>
    <p class="text-lg text-center text-white mt-2">We offer a wide range of IT services to help your business thrive.</p>
