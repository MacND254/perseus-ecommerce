<div id="cartDropdown" class="hidden absolute right-0 mt-2 w-80 bg-white shadow-lg rounded-lg p-4 border border-gray-200">
    ...
    <div id="cartItemsContainer" class="max-h-64 overflow-y-auto text-black"></div>

    <div class="border-t pt-2 mt-2">
        <p class="text-sm text-black"><strong>Subtotal:</strong> <span id="cartSubtotal" class="float-right">$0.00</span></p>
        <p class="text-sm text-black"><strong>VAT (16%):</strong> <span id="cartVAT" class="float-right">$0.00</span></p>
        <p class="text-lg font-bold text-black"><strong>Total:</strong> <span id="cartTotal" class="float-right">$0.00</span></p>
    </div>
