...
@section('content')
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center my-12">
            <h1 class="text-4xl font-bold text-gray-700">About Us</h1>
        ...
        <!-- Our Story -->
        <div class="my-12">
            <h2 class="text-3xl font-semibold text-white">Our Story</h2>
        ...
        <!-- Our Mission -->
        <div class="my-12">
            <h2 class="text-3xl font-semibold ttext-white">Our Mission</h2>
            <p class="mt-4 ttext-white leading-relaxed">
