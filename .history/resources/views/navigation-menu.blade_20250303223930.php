    ...
    <div class="max-w-7xl mx-auto flex justify-between items-center py-3 px-4">
        ...
        <ul class="hidden md:flex space-x-4">
            ...
            <li class="relative group">
                <!-- Services Button (Main Link) -->
                <a href="{{ route('services.index') }}" class="hover:bg-gray-700 px-3 py-2 rounded ">Our Services</a>

                <!-- Dropdown Toggle Button -->
                <button id="services-dropdown-toggle" class="ml-1 focus:outline-none">
                ...
                <!-- Dropdown Menu -->
                <ul id="services-dropdown-menu" class="absolute hidden bg-white text-gray-800 shadow-lg mt-2 rounded z-50 min-w-[180px]">
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 bg-gray-800 bg-opacity-95 z-50">
        <div class="relative bg-gray-700 h-full w-1/2 px-4 py-2">
            ...
            <div class="py-2 border-b border-gray-700">
                <!-- Services Button (Main Link) -->
                <a href="{{ route('services.index') }}" class="py-2 block hover:bg-gray-700">Our Services</a>

                <!-- Dropdown Toggle Button -->
                <button id="mobile-services-dropdown-toggle" class="ml-1 focus:outline-none text-white">
                    <svg class="w-4 h-4 inline-block" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                </button>
                ...
                <!-- Dropdown Menu -->
                <ul id="mobile-services-dropdown-menu" class="hidden flex flex-col bg-gray-700 mt-1 rounded">
                    <li><a href="{{ route('services.managed-it') }}" class="pl-4 py-2 hover:bg-gray-600">Managed IT Services</a></li>
                    <li><a href="{{ route('services.software-development') }}" class="pl-4 py-2 hover:bg-gray-600">Software Development</a></li>
                    <li><a href="{{ route('services.it-consulting') }}" class="pl-4 py-2 hover:bg-gray-600">IT Consulting</a></li>
                    <li><a href="{{ route('services.cloud-computing') }}" class="pl-4 py-2 hover:bg-gray-600">Cloud Computing</a></li>
                    <li><a href="{{ route('services.cybersecurity') }}" class="pl-4 py-2 hover:bg-gray-600">Cybersecurity</a></li>
                    <li><a href="{{ route('services.smart-home-automation') }}" class="pl-4 py-2 hover:bg-gray-600">Smart-Home Automation</a></li>
                    <li><a href="{{ route('services.network-installations') }}" class="pl-4 py-2 hover:bg-gray-600">All Network Installations</a></li>
                </ul>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (menuToggle && mobileMenu && menuClose && servicesToggle && mobileServicesDropdown && servicesDropdownToggle && servicesDropdownMenu) {
            // Open Mobile Menu
            ...
            servicesDropdownToggle.addEventListener('click', (event) => {
                event.preventDefault(); // Prevent button click from navigating away
            ...
            if (!servicesDropdownToggle) console.error("servicesDropdownToggle is missing");
            if (!servicesDropdownMenu) console.error("servicesDropdownMenu is missing");
        }
    });
</script>
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const mobileMenu = document.getElementById("mobile-menu");
        const menuClose = document.getElementById("menu-close");
        const servicesDropdownToggle = document.getElementById("mobile-services-dropdown-toggle");
        const servicesDropdownMenu = document.getElementById("mobile-services-dropdown-menu");
        ...
        // Close dropdown when clicking outside
        document.addEventListener("click", function (event) {
            if (!servicesDropdownMenu.contains(event.target) && !servicesDropdownToggle.contains(event.target)) {
                servicesDropdownMenu.classList.add("hidden");
            }
        });
    });
