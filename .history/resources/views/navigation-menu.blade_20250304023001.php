...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-gray-800 bg-opacity-95 z-50 transform transition-transform duration-300 ease-in-out"
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Ensure menu is hidden on load (fix flickering issue)
        ...
        if (menuToggle && mobileMenu && menuClose) {
            ...
            document.addEventListener('click', (event) => {
                if (
                    mobileMenu.style.transform === "translateX(0%)" && // Menu is open
