...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const servicesDropdownToggle = document.getElementById('services-dropdown-toggle'); // Desktop dropdown button
        const servicesDropdownMenu = document.getElementById('services-dropdown-menu'); // Desktop dropdown menu
        ...
        if (servicesDropdownToggle && servicesDropdownMenu) {
            servicesDropdownToggle.addEventListener('click', (event) => {
                event.preventDefault(); // Prevent accidental link navigation
