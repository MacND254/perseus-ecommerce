...
@section('title', 'Home | Perseus eCommerce')

@section('content')
<!-- Hero Section -->
<section class="relative bg-center bg-no-repeat bg-cover overflow-hidden" style="background-image: url('{{ asset('images/banner-R.jpg') }}');">
    ...
    <div class="absolute inset-0 flex flex-col justify-center items-center">
        ...
        <div class="oxanium-font small-text text-red-600 sm:text-x3 md:text-2xl lg:text-3xl font-bold leading-tight mt-[30px]">
            LOOKING FOR OUR SERVICES? <a href="/services" class="text-green-600 font-bold">CLICK HERE</a>
        </div>
        <p class="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-8 glow-text mt-[60px]">
...
<section class="py-12 bg-gray-100">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl font-bold mb-6 text-center">Explore Categories</h2>
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            <a href="#" class="bg-white shadow-md rounded p-4 text-center hover:bg-green-100 transition">Electronics</a>
            <a href="#" class="bg-white shadow-md rounded p-4 text-center hover:bg-green-100 transition">Clothing</a>
            <a href="#" class="bg-white shadow-md rounded p-4 text-center hover:bg-green-100 transition">Accessories</a>
            <a href="#" class="bg-white shadow-md rounded p-4 text-center hover:bg-green-100 transition">Home Appliances</a>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            @foreach($products->take(8) as $product)
                <div class="group relative bg-white rounded-lg shadow-md transition duration-300 hover:shadow-[0_0_15px_rgba(0,0,255,0.6)] flex flex-col items-center justify-between p-4 overflow-hidden hover:scale-105">
                    @php
                    ...
                    <div class="w-full h-40 flex items-center justify-center overflow-hidden rounded-lg">
                        <img src="{{ asset('storage/' . $firstImageUrl) }}" alt="{{ $product->name }}" class="object-contain h-full w-full">
                    </div>
