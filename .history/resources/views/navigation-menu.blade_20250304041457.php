...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="fixed inset-0 bg-gray-900 bg-opacity-90 backdrop-blur-lg transform translate-x-full transition-transform duration-300 ease-in-out z-50 flex flex-col">
        <div class="relative w-1/2 h-full bg-gray-800 p-6">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const menuContent = document.getElementById('menu-content'); // The actual menu inside
        ...
        // Close when clicking outside the actual menu
