...
<nav class="bg-gray-800 text-white shadow-md">
    <div class="max-w-7xl mx-auto flex justify-between items-center py-3 px-4">
        ...
        <ul>
            <div class="relative">
                <button id="cartIcon" class="text-white bg-blue-500 px-3 py-2 rounded">
                    🛒 <span id="cartCounter" class="bg-red-500 text-white px-2 py-1 rounded-full text-xs">0</span>
                </button>
