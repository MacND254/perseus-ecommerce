    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            @foreach($products->take(8) as $product)
                <div class="group relative bg-grey-300 rounded-lg shadow-md transition duration-300 hover:shadow-[0_0_15px_rgba(0,0,255,0.6)] flex flex-col items-center justify-between p-4 overflow-hidden hover:scale-105">
                    @php
