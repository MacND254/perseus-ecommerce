...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Ensure the menu is hidden off-screen initially (using translate-x-full)
        ...
        if (menuToggle && mobileMenu && menuClose) {
            ...
            menuToggle.addEventListener('click', (event) => {
                ...
                mobileMenu.classList.toggle('translate-x-full'); // Animate menu
            });
            ...
            document.addEventListener('click', (event) => {
                if (
                    !mobileMenu.classList.contains('translate-x-full') &&  // Menu is open
