...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 bg-gray-800 bg-opacity-95 z-50">
        <div class="relative bg-gray-700 h-full w-1/2 px-4 py-2">
            ...
            <div class="py-2 border-b border-gray-700 flex items-center">
                <!-- Services Button (Main Link) -->
                <a href="{{ route('services.index') }}" class="py-2 block flex-grow hover:bg-gray-700">Our Services</a>

                <!-- Dropdown Toggle Button -->
                <button id="mobile-services-dropdown-toggle" class="focus:outline-none px-2">
