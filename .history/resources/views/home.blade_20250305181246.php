...
<section class="py-12 bg-gray-100">
    <div class="container mx-auto px-4">
        ...
        <div class="relative flex justify-center items-center">
            <!-- Slider Container -->
            <div class="w-[90vw] max-w-[800px] h-[calc(90vw/2.285)] max-h-[350px] overflow-hidden rounded-lg  bg-grey">
                <div class="flex transition-transform duration-1000 ease-in-out  bg-grey" id="slider">
                    <div class="flex-none w-full h-full  bg-grey">
...
<section class="py-12 bg-gray-100">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl font-bold mb-6 text-black text-center">Explore Categories</h2>
