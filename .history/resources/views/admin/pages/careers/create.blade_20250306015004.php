...
<div class="container mx-auto mt-4">
    ...
    <form action="{{ route('admin.careers.store') }}" method="POST" enctype="multipart/form-data" x-data="careerForm()">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="apply_button_text" id="apply_button_text" class="text-black mt-1 block w-full p-2 border border-gray-300 rounded-md" value="Apply Now" required />
        </div>
