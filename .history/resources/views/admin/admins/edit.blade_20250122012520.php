            ...
            <form action="{{ route('admin.admins.update', $admin) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="mt-1 p-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('name') border-red-500 @enderror"
                    >
                    @error('name')
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="mt-1 p-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('email') border-red-500 @enderror"
                    >
                    @error('email')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    ...
                    <input
                        ...
                        id="password"
                        name="password"
                        class="mt-1 p-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('password') border-red-500 @enderror"
                    >
