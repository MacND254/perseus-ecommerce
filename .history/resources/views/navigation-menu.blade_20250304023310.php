...
<div id="menu-toggle" class="md:hidden cursor-pointer flex flex-col space-y-1">
...
<div id="mobile-menu" class="fixed inset-0 bg-gray-800 bg-opacity-95 z-50 transform transition-transform duration-300 ease-in-out translate-x-full">
    <div class="relative bg-gray-700 h-full w-1/2 px-4 py-2">
        ...
        <div class="flex flex-col space-y-2 mt-2">
            @guest
                <a href="{{ route('login') }}" class="px-3 py-2 rounded-[8px] font-semibold text-sm bg-gray-700 text-white">Sign In</a>
                <a href="{{ route('register') }}" class="px-3 py-2 rounded-[8px] font-semibold text-sm bg-gray-700 text-white">Sign Up</a>
            @else
