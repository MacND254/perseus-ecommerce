...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const mobileMenu = document.getElementById('mobile-menu'); // Mobile menu itself
        const menuClose = document.getElementById('menu-close'); // Mobile menu close button

        // Desktop dropdown elements
        const servicesDropdownToggle = document.getElementById('services-dropdown-toggle'); // "Our Services" button
        const servicesDropdownMenu = document.getElementById('services-dropdown-menu'); // Dropdown content
        ...
        /** ✅ Toggle Desktop "Our Services" Dropdown **/
        if (servicesDropdownToggle && servicesDropdownMenu) {
            ...
            document.addEventListener('click', (event) => {
                if (
                    ...
                    !servicesDropdownToggle.contains(event.target) &&
        ...
        if (!mobileMenu) console.error("❌ mobileMenu not found");
        if (!menuClose) console.error("❌ menuClose not found");
        if (!servicesDropdownToggle) console.error("❌ servicesDropdownToggle not found");
        if (!servicesDropdownMenu) console.error("❌ servicesDropdownMenu not found");
    });
</script>
