<footer class="relative bg-cover bg-center text-white py-12" style="background-image: url('{{ asset('images/footer3-bg.jpg') }}');">
    ...
    <div class="relative container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="mb-2"><strong>Address:</strong><br> Mepalux Plaza, 5th Floor Office 502, Latema Rd, Nairobi-Kenya</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ url('/home') }}" class="hover:text-green-500">Home</a></li>
                    <li><a href="{{ url('/about') }}" class="hover:text-green-500">About Us</a></li>
                    <li><a href="{{ url('/solutions') }}" class="hover:text-green-500">Solutions</a></li>
                    <li><a href="{{ url('/products') }}" class="hover:text-green-500">Products</a></li>
