...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="fixed inset-50 bg-gray-900 bg-opacity-90 backdrop-blur-lg transform translate-x-full transition-transform duration-300 ease-in-out z-50 flex flex-col">
