...
<body class="flex justify-center items-center min-h-screen bg-gray-100"
    ...
    <div class="w-full max-w-md p-8 bg-purple bg-opacity-60 backdrop-blur-lg rounded-lg shadow-lg">

        <!-- Home Button -->
        <div class="mb-4 text-left">
            <a href="{{ url('/') }}" class="text-indigo-600 hover:underline text-sm">
                ← Back to Home
            </a>
        </div>
        ...
        function togglePassword(inputId, btnId) {
            ...
            if (input.type === "password") {
                ...
                icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 hover:text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7-10-7-10-7z" />
                </svg>`;
            }
        }
    </script>
