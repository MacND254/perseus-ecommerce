    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="col-span-1">
            ...
            <form id="addToCartForm">
                ...
                @else
                    ...
                    <a href="{{ route('login') }}" class="bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 mt-4 inline-block">
                        Add to Cart
                    </a>
                @endauth
            </form>
        ...
        <div class="col-span-1 text-black">
            ...
            <div class="p-4 bg-gray-100 rounded-lg shadow-md mb-6">
                <h2 class="text-lg font-bold mb-2 text-black">Delivery Address</h2>
