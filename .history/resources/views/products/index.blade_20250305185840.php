...
<section class="container mx-auto py-12">
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-center mb-4 text-black">Shop by Category</h2>
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            @foreach($categories->take(6) as $category)
            <a href="javascript:void(0);" onclick="filterByCategory({{ $category->id }})" class="block">
                <div class="group bg-white text-black rounded-lg shadow-md hover:shadow-[0_0_15px_rgba(0,0,255,0.6)] transition duration-300 cursor-pointer flex flex-col items-center p-4 hover:scale-105">
    ...
    <h1 class="text-3xl font-bold mb-6 text-center text-white">Browse Products</h1>

    <!-- Filters -->
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 space-y-4 md:space-y-0">
        <div>
            <label for="category" class="mr-2 font-semibold text-white">Category:</label>
            <select id="category" class="p-2 border rounded text-black">
        ...
        <div>
            ...
            <select id="sort" class="p-2 border rounded text-black">
