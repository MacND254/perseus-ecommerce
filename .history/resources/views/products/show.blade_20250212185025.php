...
<form id="addToCartForm">
    ...
    <input type="number" id="quantity" name="quantity" value="1" min="1" class="mt-1 w-20 p-2 border rounded">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        document.getElementById("addToCartForm").addEventListener("submit", function (event) {
            ...
            .then(data => {
                console.log("Response received:", data);  // Debugging: Check server response
    
                if (data.success) {
                    cartMessage.textContent = data.success;
                    cartMessage.classList.remove("hidden", "text-red-500");
                    cartMessage.classList.add("text-green-500");
                } else if (data.error) {
                    cartMessage.textContent = "Error: " + data.error;
                    cartMessage.classList.remove("hidden", "text-green-500");
        ...
        <div class="col-span-1">
            ...
            <div class="p-4 bg-gray-100 rounded-lg shadow-md mb-6">
                <h2 class="text-lg font-b

        <!-- Right Column: Delivery,old mb-2">Shipping Information</h2>
