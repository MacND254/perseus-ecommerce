...
<div id="mobile-menu" class="hidden fixed inset-0 bg-gray-800 bg-opacity-95 z-9999">
    <div class="relative bg-gray-800 h-full w-1/2 px-4 py-2">
        ...
        <div class="flex flex-col space-y-2 mt-2">
            @guest
                <a href="{{ route('login') }}"
                   class="px-3 py-2 rounded-[8px] font-semibold text-sm relative overflow-hidden transition-colors duration-300 ease-in-out"
                   style="background: linear-gradient(to right, #4B0082, #8A2BE2);
                          color: white;
                          box-shadow: 0 0 10px rgba(75, 0, 130, 0.3);"
                   onmouseover="this.style.background = 'linear-gradient(to right, #8A2BE2, #4B0082)';
                                this.style.boxShadow = '0 0 20px rgba(75, 0, 130, 0.5)';"
                   onmouseout="this.style.background = 'linear-gradient(to right, #4B0082, #8A2BE2)';
                               this.style.boxShadow = '0 0 10px rgba(75, 0, 130, 0.3)';">
                    <span class="absolute inset-0 bg-white opacity-0 transition-opacity duration-300 ease-in-out"
                          style="pointer-events: none;"></span> <span class="relative">Sign In</span>
                </a>
