...
<nav class="bg-gray-800 text-white shadow-md">
    <div class="max-w-7xl mx-auto flex justify-between items-center py-3 px-4">
        ...
        <ul class="hidden md:flex space-x-4">
            ...
            <li class="relative group">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('services.index') }}"
                       class="hover:bg-gray-700 px-3 py-2 rounded flex-1">
                        Our Services
                    </a>

                    <!-- Dropdown Toggle -->
                    <button id="servicesDropdownBtn"
                            class="hover:bg-gray-700 px-2 py-2 rounded focus:outline-none">
                        ▼
                    </button>
                </div>
                ...
                <ul id="servicesDropdown"
                    class="absolute hidden bg-white text-gray-800 shadow-lg mt-2 rounded z-50 min-w-[180px]">
            ...
            <script>
                document.getElementById('servicesDropdownBtn').addEventListener('click', function (event) {
                ...
                document.addEventListener('click', function (event) {
                    let dropdown = document.getElementById('servicesDropdown');
                    let button = document.getElementById('servicesDropdownBtn');
