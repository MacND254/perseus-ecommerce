...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Cloud Migration and Implementation</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Cloud Infrastructure Management</h2>
                <p class="text-gray-700 mt-2">
