...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Cloud Migration and Implementation</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Cloud Storage and Backup Solutions</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Cloud Application Development</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Cloud Security and Compliance</h2>
                <p class="text-white mt-2">
