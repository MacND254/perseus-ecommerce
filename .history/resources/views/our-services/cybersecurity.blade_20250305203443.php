...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Vulnerability Assessments and Penetration Testing</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Security Audits and Compliance Checks</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Firewall Management and Intrusion Detection</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Data Encryption and Protection</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Security Awareness Training</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Incident Response and Recovery</h2>
                <p class="text-white mt-2">
