...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Web Application Development</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Mobile App Development</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Desktop Software Development</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">API Development and Integration</h2>
                <p class="text-white mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-500">Software Testing and Quality Assurance</h2>
                <p class="text-white mt-2">
