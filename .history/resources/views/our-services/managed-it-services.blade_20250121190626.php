...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Network Monitoring and Management</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Server Maintenance and Support</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Help Desk Support for End-Users</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Cybersecurity Protection</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Data Backup and Disaster Recovery</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Cloud Services Management</h2>
                <p class="text-gray-700 mt-2">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Regular System Updates and Patching</h2>
                <p class="text-gray-700 mt-2">
