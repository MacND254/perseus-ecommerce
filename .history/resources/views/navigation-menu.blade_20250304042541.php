...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="fixed inset-y-0 left-0 w-1/2 bg-gray-900 bg-opacity-70 backdrop-blur-lg transform translate-x-full transition-transform duration-300 ease-in-out z-50 flex flex-col">
        <div class="relative w-1/2 h-full w-full bg-gray-800 p-6">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const menuToggle = document.getElementById('menu-toggle'); // Button to open menu
        ...
        const openMenu = () => {
            mobileMenu.classList.remove('-translate-x-full'); // Moves menu into view
        };

        const closeMenu = () => {
            mobileMenu.classList.add('-translate-x-full'); // Moves menu out of view
        };
