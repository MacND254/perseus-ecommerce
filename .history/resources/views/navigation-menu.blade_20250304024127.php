    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (menuToggle && mobileMenu && menuClose) {
            ...
            menuToggle.addEventListener('click', (event) => {
                ...
                mobileMenu.classList.toggle('-translate-x-full'); // Hide menu
            });

            // ✅ Close Mobile Menu when clicking the close button
            menuClose.addEventListener('click', (event) => {
                event.stopPropagation();
                mobileMenu.classList.add('hidden', '-translate-x-full'); // Hide menu
            });

            // ✅ Close Mobile Menu when clicking outside of it
            document.addEventListener('click', (event) => {
                if (
                    !mobileMenu.contains(event.target) && // If clicked outside the menu
                    !menuToggle.contains(event.target) // If clicked outside the hamburger button
                ) {
                    mobileMenu.classList.add('hidden', '-translate-x-full'); // Hide menu
                }
            });

            console.log("✅ Tailwind Mobile Menu script loaded successfully.");
        } else {
