...
<nav class="bg-gray-800 text-white shadow-md">
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="hidden fixed top-[58px] left-0 w-1/2 h-[calc(100%-60px)] bg-gray-900 bg-opacity-70 backdrop-blur-lg transform -translate-x-full transition-transform duration-300 ease-in-out z-50 flex flex-col">
