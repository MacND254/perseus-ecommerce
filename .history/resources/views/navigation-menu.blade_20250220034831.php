        ...
        <ul>
            <div class="relative">
                ...
                <div id="cartDropdown" class="absolute right-0 mt-2 w-64 bg-white shadow-lg rounded-lg p-4 hidden">
                    <div id="cartItemsContainer" class="max-h-60 overflow-auto"></div>

                    <!-- Cart Summary -->
                    <div class="border-t pt-2">
                        <p class="text-sm">Subtotal: <span id="subtotal" class="font-bold">KSh 0.00</span></p>
                        <p class="text-sm">VAT (16%): <span id="vat" class="font-bold">KSh 0.00</span></p>
                        <p class="text-lg font-bold">Total: <span id="total">KSh 0.00</span></p>
                    </div>

                    <!-- Buttons -->
                    <div class="mt-3 flex justify-between">
                        <button id="clearCart" class="bg-red-500 text-white px-4 py-2 rounded hidden">Clear</button>
                        <a href="/checkout" id="checkout" class="bg-green-500 text-white px-4 py-2 rounded hidden">Checkout</a>
                    </div>
                </div>
            </div>
        </ul>
