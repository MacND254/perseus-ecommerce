...
{
    if (!Auth::check()) {
        return view('partials.cart-dropdown', ['cartItems' => [], 'subtotal' => 0, 'vat' => 0, 'total' => 0, 'cartCount' => 0]);
    }
    ...
    foreach ($cartItems as $item) {
        // Decode the JSON image data
        $images = json_decode($item->product->product_image, true);
        // Get the first image or set a default placeholder
