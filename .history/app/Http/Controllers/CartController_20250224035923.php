...
{
    die("Function is running"); // <--- If this appears, function is being called
    ...
    foreach ($cartItems as $item) {
        ...
        if (is_array($images) && !empty($images)) {
            $item->first_image = asset('storage/' . $images[0]);
        } else {
            $item->first_image = asset('images/default-placeholder.png');
        }
    }

    dd($cartItems->toArray()); // <---- This should stop execution and show the cart items
