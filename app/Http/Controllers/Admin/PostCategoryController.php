...
class PostCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.post_categories.index')->with('success', 'Category created successfully.');
    }
    ...
    public function update(Request $request, PostCategory $postCategory)
    {
        ...
        return redirect()->route('admin.post_categories.index')->with('success', 'Category updated successfully.');
    }
    ...
    {
        $postCategory->delete();
        return redirect()->route('admin.post_categories.index')->with('success', 'Category deleted successfully.');
    }
}
